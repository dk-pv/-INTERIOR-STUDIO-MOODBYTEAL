...
export default function ContactPage() {
  ...
  return (
    <main data-theme="light" style={{ backgroundColor: "#f5f4f0", color: "#0a0a0a" }}>
      ...
      >
        ...
        >
          <div style={{ width: 20, height: 1, backgroundColor: "rgba(10,10,10,0.3)" }} />
          <span
            style={{
              fontFamily: "'DM Mono', monospace",
              fontSize: "0.58rem",
        ...
        >
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "linear-gradient(to top, rgba(10,10,10,0.55), rgba(10,10,10,0.1))",
            }}
          />
      ...
      >
        ...
        >
          {[
            { label: "Email", value: "hello@tealculture.in", href: "mailto:hello@tealculture.in" },
            { label: "Phone", value: "+91 98765 43210", href: "tel:+919876543210" },
            { label: "Instagram", value: "@tealculture", href: "https://instagram.com" },
