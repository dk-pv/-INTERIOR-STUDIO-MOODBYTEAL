...
const socials = [
  { label: "Behance", href: "https://behance.net", icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M22 7h-7V5h7v2zm1.726 10c-.442 1.297-2.029 3-5.101 3-3.074 0-5.564-1.729-5.564-5.675 0-3.91 2.325-5.92 5.466-5.92 3.082 0 4.964 1.782 5.375 4.426.078.506.109 1.188.095 2.14H15.97c.13 1.2.247 1.98 1.202 2.441.738.356 1.743.199 2.553-.31zm-5.188-4h3.485c-.091-1.256-.748-1.742-1.703-1.742-.968 0-1.615.491-1.782 1.742zM7.824 12.335c1.07-.292 1.769-1.178 1.769-2.197 0-1.791-1.317-3.138-3.568-3.138H0v11h6.222c2.337 0 3.994-1.398 3.994-3.439 0-1.244-.556-2.116-2.392-2.226zM2.569 9h3.029c.73 0 1.274.491 1.274 1.16 0 .671-.543 1.163-1.274 1.163H2.569V9zm3.364 6H2.569v-2.427h3.364c.821 0 1.388.524 1.388 1.214C7.321 14.476 6.754 15 5.933 15z" /></svg> },
  { label: "TikTok", href: "https://tiktok.com", icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.17 8.17 0 004.79 1.53V6.78a4.85 4.85 0 01-1.02-.09z" /></svg> },
  { label: "YouTube", href: "https://youtube.com", icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg> },
  ...
  { label: "Pinterest", href: "https://pinterest.com", icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12c0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738a.36.36 0 01.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.632-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0z" /></svg> },
  { label: "Facebook", href: "https://facebook.com", icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg> },
  { label: "X", href: "https://x.com", icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" /></svg> },
];
...
export default function Footer() {
  ...
  return (
    <footer style={{ backgroundColor: "#060606", position: "relative", overflow: "hidden" }}>

      {/* ── Starfield ── */}
      <div aria-hidden style={{ position: "absolute", inset: 0, pointerEvents: "none" }}>
        {[
          [8,18],[22,8],[40,22],[60,10],[76,28],[90,14],[94,44],[84,60],[70,78],[52,88],
          [32,82],[16,64],[4,46],[20,92],[46,96],[68,84],[80,44],[95,70],[36,40],[62,55],
          [26,58],[50,28],[72,18],[88,82],[12,78],[46,68],[82,34],[16,34],[60,72],[92,54],
        ].map(([x, y], i) => (
          <div key={i} style={{
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse at 50% 30%, rgba(255,110,0,0.09) 0%, transparent 70%)",
        }} />
      </div>
      ...
      >
        ...
        <div className="tc-col-left">
          <div className="tc-contact-card">
            ...
            <div style={{ display: "flex", gap: 10, marginBottom: 10, alignItems: "center" }}>
              ...
              {/* WhatsApp icon */}
              <svg width="15" height="15" viewBox="0 0 24 24" fill="rgba(255,255,255,0.38)">
            ...
            <a href="tel:+919645588005" className="tc-phone">+91 964 558 8005</a>
            <a href="tel:+971557336946" className="tc-phone">+971 55733 6946</a>
            ...
            <a href="mailto:tealculturestudio@gmail.com" className="tc-email">tealculturestudio@gmail.com</a>
          </div>
        </div>
        ...
        <div className="tc-col-right">
          ...
          <a href="https://www.teal.com" target="_blank" rel="noopener noreferrer" className="tc-www">
            www.teal.com
          </a>
          <div className="tc-socials">
            {socials.map((s) => (
              <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                aria-label={s.label} className="tc-soc-icon">
                {s.icon}
              </a>
            ))}
          </div>
      ...
      <div className="tc-bottom-bar">
        <span>© {new Date().getFullYear()} TEALCULTURE — All rights reserved</span>
        <span>moodyTEAL Studio</span>
      </div>
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .tc-footer-3col {
          ...
          max-width: 1100px;
          margin: 0 auto;
          padding: 36px clamp(28px, 5vw, 72px) 20px;
          position: relative;
        }
